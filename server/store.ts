// The account store: who the users are, their sessions, and their recent
// AI uses. That is the whole list of what the server keeps. Achievements
// and photos never come here.
//
...
// sessions:<id> = set of tokens, usage:<id> = JSON list of timestamps (expires).
